# Taken from Home-Manager Module with a small patch to allow absolute paths
        ...
        type = types.attrsOf (types.submodule ({ config, name, ... }: {
          options = {
            ...
            isRelative = mkOption {
              type = types.int;
              default = 1;
              description = "Whether path is relative to firefox home directory";
            };
          ...
          || profile.search.order != [ ] || profile.search.engines != { })
        {
          ...
          source =
            let
              ...
              privateSalt =
                if profile.search.privateDefault != null then
