...

{
  dconf.settings = {
    ...
    "org/gnome/TextEditor" = {
      last-save-directory = "file:///home/wickedwizard/.thunderbird";
    };
    ...
    "org/gnome/evince/default" = {
      ...
      window-ratio = mkTuple [ 1.0473856209150327 0.7108585858585859 ];
    };
